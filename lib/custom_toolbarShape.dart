...
//First oval
    ...
    Gradient gradient = LinearGradient(
      colors: <Color>[
        const Color.fromARGB(255, 92, 115, 218).withOpacity(1),
        const Color.fromARGB(255, 25, 94, 205).withOpacity(1),
      ],
      stops: const [
        0.3,
        1.0,
...
//Second oval
    ...
    gradient = LinearGradient(
      colors: <Color>[
        const Color.fromARGB(255, 13, 60, 180).withOpacity(0.1),
        const Color.fromARGB(255, 171, 201, 238).withOpacity(0.2),
      ],
      stops: const [
        0.0,
        1.0,
    ...
    Paint secondOvalPaint = Paint()
      ..color = const Color.fromARGB(255, 80, 134, 226)
...
//Third oval
    ...
    gradient = LinearGradient(
      colors: <Color>[
        ...
        const Color.fromARGB(255, 121, 163, 220).withOpacity(0.2),
      ],
      stops: const [
        0.0,
        1.0,
...
//Fourth oval
    ...
    gradient = LinearGradient(
      colors: <Color>[
        const Color.fromARGB(255, 18, 52, 130).withOpacity(0.9),
        const Color.fromARGB(255, 81, 122, 192).withOpacity(0.3),
      ],
      stops: const [
        0.3,
        1.0,
    ...
    Paint fourthOvalPaint = Paint()
      ..color = const Color.fromARGB(255, 59, 90, 181)
